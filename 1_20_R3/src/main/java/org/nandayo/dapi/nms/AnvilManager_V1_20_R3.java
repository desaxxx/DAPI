...
public class AnvilManager_V1_20_R3 extends AnvilWrapper {
    ...
    static private class MenuAnvil extends ContainerAnvil implements MenuAnvilWrapper {
        ...
        public void m() { /* createResult() */
            ...
            if(resultSlot.g().b()) { /* getItem(), isEmpty() */
                resultSlot.f(b(0).g().p()); /* set(), getSlot(i).getItem().cloneItemStack() */
            }
            d(); /* broadcastChanges() */
