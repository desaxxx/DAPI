...
public class ChannelTitleMessage extends ChannelMessage {
    ...
    public ChannelTitleMessage(Component message, Component secondaryMessage, int fadeInTicks, int stayTicks, int fadeOutTicks) {
        this(Validate.validateReturn(() -> miniMessage.serialize(message), "Message cannot be null!"),
                Validate.validateReturn(() -> miniMessage.serialize(secondaryMessage), "Secondary message cannot be nul!"),
    ...
    public ChannelTitleMessage(Component message, Component secondaryMessage) {
        this(Validate.validateReturn(() -> miniMessage.serialize(message), "Message cannot be null!"),
                Validate.validateReturn(() -> miniMessage.serialize(secondaryMessage), "Secondary message cannot be null!"));
    }
